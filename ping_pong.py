...
# First, we will create the screen
...
def paddle_L_down():
    y = left_paddle.ycor()
    if y > -240:  # Keep paddle within the screen
        y -= 20
    left_paddle.sety(y)
...
# Binding the keys for moving the paddles up and down
screen_1.listen()
...
while True:
    ...
    if hit_ball.xcor() > 500:
        ...
        left_player += 1
        sketch_1.clear()
        sketch_1.write("Left Player : {}    Right Player: {}".format(
